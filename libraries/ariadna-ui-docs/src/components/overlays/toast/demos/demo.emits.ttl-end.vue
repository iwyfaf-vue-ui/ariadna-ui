<template>
  <Toast group="emit-ttl-end" @ttl-end="(payload: TToastEvent) => console.log(payload)" />
...
import type { TToastEvent } from '@iwyfaf-vue-ui/ariadna-ui/Toast';
