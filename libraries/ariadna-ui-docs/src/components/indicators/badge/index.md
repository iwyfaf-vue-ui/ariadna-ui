...
|-------------| -------- |--------------------------------------------------------------------|-------------|----------------------------------------------------------------------------------------------------|
| `size`      | -        | `'small' \| 'medium' \| 'large'`                                   | `medium`    | Предопределенные варианты размеров для значка.                                                     |
...
| `cssClass`  | -        | `string`                                                           | `ar-badge`  | Переопределяет структуру CSS классов.                                                              |
...
- **Тип:** `string`
- **Значение по умолчанию:** `ar-badge`
...
| Slot       | Description                                 |
|------------|---------------------------------------------|
| `default`  | Используется для вывода содержимого значка. |
