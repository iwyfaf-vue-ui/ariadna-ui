...
::: warning Важно!
Компонент использует `<RouterLink>` для навигации по приложению, но не поставляет Vue Router как зависимость.
Для корректной работы, вам необходимо установить Vue Router как зависимость или использовать сторонний фреймворк, в 
котором уже установлен Vue Router.
:::
