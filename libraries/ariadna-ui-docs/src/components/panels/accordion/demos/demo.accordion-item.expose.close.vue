<template>
  <Accordion>
    ...
    <AccordionItem ref="accordionItem" opened>
  ...
  <Button @click="accordionItemRef?.close()">Close Item 2</Button>
</template>
...
const accordionItemRef = useTemplateRef<InstanceType<typeof AccordionItem>>('accordionItem');
</script>
