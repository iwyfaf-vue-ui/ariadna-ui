<template>
  <Accordion ref="accordion" opened>
    <AccordionItem>
  ...
  <Button @click="accordionRef?.closeAll()">Close all accordions</Button>
</template>
...
const accordionRef = useTemplateRef<InstanceType<typeof Accordion>>('accordion');
</script>
