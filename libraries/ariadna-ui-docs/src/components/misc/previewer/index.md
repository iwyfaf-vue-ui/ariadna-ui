...
- **Описание:** Используется для вывода заголовка над просматриваемым компонентом.
- **Тип:** `() => VNode[]`
...
- **Описание:** Используется для вывода описание над просматриваемым компонентом и под заголовком.
- **Тип:** `() => VNode[]`
