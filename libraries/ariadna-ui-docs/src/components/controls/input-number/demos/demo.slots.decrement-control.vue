<template>
  <InputNumber
    v-model:addon-before="addonBeforeValue"
    v-model="inputNumberValue"
    v-model:addon-after="addonAfterValue"
    label="Custom decrement control"
    controls
  >
    <template #addonBefore> 💲 </template>
    <template #decrementControl>
      <Button>➖</Button>
    </template>
