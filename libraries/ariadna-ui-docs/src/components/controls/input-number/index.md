...
InputNumber - представляет собой компонент HTML элемента `<input>` в текстовой форме предназначенный для обеспечения 
числового ввода.
...
InputNumber - Vue-компонент предназначен для ввода и управления числовыми значениями с возможностью 
...
- **Тип:** `string`
- **Значение по умолчанию:** `EInputNumberPropsDefault.CSS_CLASS`
