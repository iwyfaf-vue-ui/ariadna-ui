  ...
  <div>
    ...
    >
      ...
      <template #sliderItem="{ mediaItem, registerIframe }">
        <Button @click="onPrev" modifier="secondary">Prev</Button>
...
function useViewerComponent() {
  ...
  return { viewerLoaded, open, onOpen, onClose, onPrev };
}

const { viewerLoaded, open, onOpen, onClose, onPrev } = useViewerComponent();
</script>
