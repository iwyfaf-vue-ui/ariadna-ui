...
describe('useSidebarMenuItemBadge.ts: Basic functionality.', () => {
...
describe('useSidebarMenuItemBadge.ts: isBadgeNotComponent', () => {
...
describe('useSidebarMenuItemBadge.ts: componentClasses computed.', () => {
  it('Should return correct componentClasses for string badge.', () => {
    mount({
      ...
      setup() {
        ...
        expect(componentClasses.value).toBe(defaultMock.getSelectorWithoutDot(defaultMock.badgeEl));
      },
    });
  });
