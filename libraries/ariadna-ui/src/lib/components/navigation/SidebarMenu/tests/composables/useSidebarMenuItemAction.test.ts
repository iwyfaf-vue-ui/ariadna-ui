...
describe('useSidebarMenuItemAction.ts: Basic functionality.', () => {
...
describe('useSidebarMenuItemAction.ts: isActionString ComputedRef.', () => {
...
describe('useSidebarMenuItemAction.ts: componentClasses ComputedRef.', () => {
