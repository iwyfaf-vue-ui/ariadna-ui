...
/**
 * @description
 * Return type for the `useInputText` composable function.
 * Contains reactive properties and methods for InputText component functionality.
 */
export type TUseInputTextReturn = {
  /**
