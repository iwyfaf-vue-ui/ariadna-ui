...
import { InputTextSelectorTestData } from '../../tests/test-data/InputText.selector.test-data';

const defaultMock = new InputTextSelectorTestData();

function mountWithComposable(props: TInputTextProps, slots: any = {}, route = { path: '/' }) {
  const emits = vi.fn();

  return mount(
    defineComponent({
      setup() {
        const result = useInputText(props, slots, emits);
        return { ...result, emits };
      },
      render() {
        return h('div');
...
describe('useInputText.ts: Basic functionality.', () => {
...
describe('useInputText.ts: uniqueID ComputedRef.', () => {
...
describe('useInputText.ts: defaultPlaceholder ComputedRef.', () => {
...
describe('useInputText.ts: listeners ComputedRef.', () => {
...
describe('useInputText.ts: onExpandEnter Function.', () => {
...
describe('useInputText.ts: onExpandAfterEnter Function.', () => {
...
describe('useInputText.ts: onExpandBeforeLeave Function.', () => {
