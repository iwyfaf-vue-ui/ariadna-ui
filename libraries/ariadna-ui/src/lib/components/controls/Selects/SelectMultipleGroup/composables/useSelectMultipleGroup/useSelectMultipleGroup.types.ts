...
/**
 * @description
 * Return type for the `useSelectMultipleGroup` composable function.
 * Contains reactive properties and methods for SelectMultipleGroup component functionality.
 */
export type TUseSelectMultipleGroupReturn = {
  /**
   * Reactive reference indicating whether the SelectMultipleGroup dropdown is currently opened.
   */
