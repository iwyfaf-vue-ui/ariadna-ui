...
import type { TUseSelectMultipleGroupReturn } from './useSelectMultipleGroup.types';
import type {
  TSelectMultipleGroupProps,
  TSelectMultipleGroupEmits,
} from '../../SelectMultipleGroup';

export default function useSelectMultipleGroup(
  props: TSelectMultipleGroupProps,
  emits: TSelectMultipleGroupEmits,
): TUseSelectMultipleGroupReturn {
  const id = useId();
