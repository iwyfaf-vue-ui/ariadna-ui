...
import type { ESelectMultipleGroupPropsDefault } from './types/SelectMultipleGroup.enums';
import type { TSelectMultipleGroupFilter } from './types/SelectMultipleGroup.types';

/**
 * Component props definition.
 */
export type TSelectMultipleGroupProps = {
  /**
   ...
   * @default []
   * @required
   * @example v-model="selectMultipleGroupValue"
   */
  modelValue: Array<Record<string, any>> | Array<any>;
  ...
  /**
   * An array of SelectMultipleGroup items to display as the available options.
   *
   * @type Array<Record<string, any>> | Array<any>
   * @default []
   * @required
   * @example :options="selectMultipleGroupOptions"
   */
   ...
   *
   * @type string
   * @default {@link ESelectMultipleGroupPropsDefault.OPTION_LABEL}
   ...
   *
   * @type string
   * @default {@link ESelectMultipleGroupPropsDefault.OPTION_GROUP_LABEL}
   ...
   *
   * @type string
   * @default {@link ESelectMultipleGroupPropsDefault.OPTION_GROUP_CHILDREN}
   ...
   * @default {@link ESelectMultipleGroupPropsDefault.SIZE}
   * @example size="small"
   * @example size="medium"
   * @example size="large"
   */
   ...
   *
   * @type TSelectMultipleGroupFilter
   * @default undefined
   * @example :filter="{ filterLabel: [[{ field: 'label' }]] }"
   */
  filter?: TSelectMultipleGroupFilter;
   ...
   *
   * @type string
   * @default {@link ESelectMultipleGroupPropsDefault.CSS_CLASS}
   ...
   *
   * @type string
   * @default {@link ESelectMultipleGroupPropsDefault.ARIA_LABEL}
 ...
 */
export type TSelectMultipleGroupSlots = {
  /**
 ...
 */
export type TSelectMultipleGroupEmits = {
  /**
   * Emitted when the model value is updated.
   *
   * @param {"update:model-value"} e - The event name: 'update:model-value'.
   * @param {TSelectMultipleGroupProps['modelValue']} payload - The new value of the SelectMultipleGroup component.
   */
  (e: 'update:model-value', payload: TSelectMultipleGroupProps['modelValue']): void;

  /**
   * Emitted when the model value filter is updated.
   *
   * @param {"update:filter-value"} e - The event name: 'update:model-value-filter'.
   * @param {TSelectMultipleGroupProps['filterValue']} payload - The new filter value of the SelectMultipleGroup component.
   */
  (e: 'update:filter-value', payload: TSelectMultipleGroupProps['filterValue']): void;
 ...
 *
 * SelectMultipleGroup component is used to select multiple items from a grouped collection.
 */
declare class SelectMultipleGroup extends ClassComponent<
...
declare module '@vue/runtime-core' {
  interface GlobalComponents {
    SelectMultipleGroup: GlobalComponentConstructor<SelectMultipleGroup>;
  }
}
