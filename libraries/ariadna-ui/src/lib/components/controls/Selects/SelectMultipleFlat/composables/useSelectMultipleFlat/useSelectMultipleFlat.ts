...
import type { TUseSelectMultipleFlatReturn } from './useSelectMultipleFlat.types';
import type { TSelectMultipleFlatProps, TSelectMultipleFlatEmits } from '../../SelectMultipleFlat';

export default function useSelectMultipleFlat(
  props: TSelectMultipleFlatProps,
  emits: TSelectMultipleFlatEmits,
): TUseSelectMultipleFlatReturn {
  const id = useId();
