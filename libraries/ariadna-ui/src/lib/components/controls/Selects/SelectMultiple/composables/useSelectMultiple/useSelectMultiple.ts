...
import type { TUseSelectMultipleReturn } from './useSelectMultiple.types';
import type { TSelectMultipleProps, TSelectMultipleEmits } from '../../SelectMultiple';

export default function useSelectMultiple(
  props: TSelectMultipleProps,
  emits: TSelectMultipleEmits,
): TUseSelectMultipleReturn {
  const id = useId();
