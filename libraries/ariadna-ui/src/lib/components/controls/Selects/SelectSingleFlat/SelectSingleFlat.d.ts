...
import type { Primitive } from '../../../../../types/index';
import type { VNode } from 'vue';
import type { ESelectSingleFlatPropsDefault } from './types/SelectSingleFlat.enums';
import type { TSelectSingleFlatVirtualScroller } from './types/SelectSingleFlat.types';

/**
 * Component props definition.
 */
export type TSelectSingleFlatProps = {
  /**
   ...
   * @default null
   * @required
   * @example v-model="selectSingleFlatValue"
   */
  ...
  /**
   * An array of SelectSingleFlat items to display as the available options.
   *
   * @type Array<Primitive>
   * @default []
   * @required
   * @example :options="selectSingleFlatOptions"
   */
   ...
   * @default {@link ESelectSingleFlatPropsDefault.SIZE}
   * @example size="small"
   * @example size="medium"
   * @example size="large"
   */
   ...
   *
   * @type TSelectSingleFlatVirtualScroller
   * @default undefined
   * @example :virtual-scroller="{ itemHeight: 40, height: 200 }"
   */
  virtualScroller?: TSelectSingleFlatVirtualScroller;
   ...
   *
   * @type string
   * @default {@link ESelectSingleFlatPropsDefault.CSS_CLASS}
   ...
   *
   * @type string
   * @default {@link ESelectSingleFlatPropsDefault.ARIA_LABEL}
 ...
 */
export type TSelectSingleFlatSlots = {
  /**
 ...
 */
export type TSelectSingleFlatEmits = {
  /**
   * Emitted when the model value is updated.
   *
   * @param {"update:model-value"} e - The event name: 'update:model-value'.
   * @param {TSelectSingleFlatProps['modelValue']} payload - The new value of the SelectSingle component.
   */
  (e: 'update:model-value', payload: TSelectSingleFlatProps['modelValue']): void;

  /**
   * Emitted when the model value filter is updated.
   *
   * @param {"update:filter-value"} e - The event name: 'update:model-value-filter'.
   * @param {TSelectSingleFlatProps['filterValue']} payload - The new filter value of the SelectSingle component.
   */
  (e: 'update:filter-value', payload: TSelectSingleFlatProps['filterValue']): void;
 ...
 *
 * SelectSingleFlat component is used to select single item from a flat collection.
 */
declare class SelectSingleFlat extends ClassComponent<
...
declare module '@vue/runtime-core' {
  interface GlobalComponents {
    SelectSingleFlat: GlobalComponentConstructor<SelectSingleFlat>;
  }
}

export default SelectSingleFlat;
