...
/**
 * @description
 * Return type for the `useSelectSingleFlat` composable function.
 * Contains reactive properties and methods for SelectSingleFlat component functionality.
 */
export type TUseSelectSingleFlatReturn = {
  /**
   * Reactive reference indicating whether the SelectSingle dropdown is currently opened.
   */
