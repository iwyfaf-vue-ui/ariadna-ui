...
import type { TUseSelectSingleFlatReturn } from './useSelectSingleFlat.types';
import type { TSelectSingleFlatEmits, TSelectSingleFlatProps } from '../../SelectSingleFlat';

export default function useSelectSingleFlat(
  props: TSelectSingleFlatProps,
  emits: TSelectSingleFlatEmits,
): TUseSelectSingleFlatReturn {
  const id = useId();
