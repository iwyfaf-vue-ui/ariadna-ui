...
import type { TUseSelectSingleGroupReturn } from './useSelectSingleGroup.types';
import type { TSelectSingleGroupEmits, TSelectSingleGroupProps } from '../../SelectSingleGroup';

export default function useSelectSingle(
  props: TSelectSingleGroupProps,
  emits: TSelectSingleGroupEmits,
): TUseSelectSingleGroupReturn {
  const id = useId();
