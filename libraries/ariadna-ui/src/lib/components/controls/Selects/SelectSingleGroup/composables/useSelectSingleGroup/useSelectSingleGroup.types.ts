...
/**
 * @description
 * Return type for the `useSelectSingleGroup` composable function.
 * Contains reactive properties and methods for SelectSingleGroup component functionality.
 */
export type TUseSelectSingleGroupReturn = {
  /**
   * Reactive reference indicating whether the SelectSingleGroup dropdown is currently opened.
   */
