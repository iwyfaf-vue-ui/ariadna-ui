  ...
  <div>
    ...
    >
      ...
      <template #sliderItem="{ mediaItem, registerIframe }">
        <Button @click="onGoTo(2)" modifier="secondary">Go to 2 element</Button>
...
function useViewerComponent() {
  ...
  return { viewerLoaded, open, onOpen, onClose, onGoTo };
}

const { viewerLoaded, open, onOpen, onClose, onGoTo } = useViewerComponent();
</script>
