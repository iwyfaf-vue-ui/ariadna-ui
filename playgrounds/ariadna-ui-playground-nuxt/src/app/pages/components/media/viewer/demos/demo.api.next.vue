  ...
  <div>
    ...
    >
      ...
      <template #sliderItem="{ mediaItem, registerIframe }">
        <Button @click="onNext" modifier="secondary">Next</Button>
...
function useViewerComponent() {
  ...
  return { viewerLoaded, open, onOpen, onClose, onNext };
}

const { viewerLoaded, open, onOpen, onClose, onNext } = useViewerComponent();
</script>
